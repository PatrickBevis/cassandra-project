 ...
 */
final class Version20260203082216 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE customer (id INT AUTO_INCREMENT NOT NULL, invoice_id INT DEFAULT NULL, address_id INT DEFAULT NULL, company_name VARCHAR(50) NOT NULL, email VARCHAR(30) NOT NULL, siret_number VARCHAR(14) DEFAULT NULL, phone_number VARCHAR(12) NOT NULL, UNIQUE INDEX UNIQ_81398E09E7927C74 (email), INDEX IDX_81398E092989F1FD (invoice_id), INDEX IDX_81398E09F5B7AF75 (address_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
